...
//                usrArr[3]->printAdUsr();                                            
            ...
            case 4:  // Edit surveys in binary and text files
            {    
                int n = 0;  
                Admin admin4;
            ...
            {
                cout << endl << endl;
                //this one will be given to the admin to create surveys
                runSurveyCreator();
                break;
            }
            default: {
...
void Admin::getAllUsrs(Admin **usrArr){
    ...
    while(i < nRec){
        ...
        // Read in size of surveys and add to cursor
        inBin.read(reinterpret_cast<char *>(&num) , sizeof(int)); 
...
/******************************************************************/ 
//                     Reset surveys in User object
//                   and rewrite binary & text files
/******************************************************************/ 

void Admin::setUsrTime(){ 
    
    int score = 0;
    
    do {
        cout<<"\nEdit " << user.getName() << "'s surveys." << endl;
                
        cout << "Enter how many surveys you want the user to have completed." << endl;
        cin >> score;
